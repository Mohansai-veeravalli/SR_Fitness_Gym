            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                     <?php  $r=mysqli_query($con,"select * from member order by id desc");
					while($s=mysqli_fetch_array($r))
					{
                      ...
                      <tr>
                       ...
                       <td><a href="print_member.php?receipt=<?php echo $s['receipt']; ?>" target="_blank"><font color=ORANGE>Print</font></a>&nbsp;<a href="edit_member.php?member_id=<?php echo $s['id'];?>"><font color=blue>View/Edit</font></a>&nbsp;<a href="manage_member.php?delete_id=<?php echo $s['id']; ?>" onclick="return delete_call()"><font color=red>Delete</font></a>
                      </tr>
