                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Memeber having birthday today<?php echo $message; ?></strong>
                        </div>
                        <div class="card-body">
	 ...
	 $r=mysqli_query($con,"select * from member where dob between'".$today_date."' and '".$yesterday_date."' order by id desc");
					...
					while($s=mysqli_fetch_array($r))
					{
                      ...
                      <tr>
                       ...
                       <td><a href="edit_member.php?member_id=<?php echo $s['id'];?>"><font color=blue>View&Edit</font>
                      </tr>
