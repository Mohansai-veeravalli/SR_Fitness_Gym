            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                  ...
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                     <?php  $r=mysqli_query($con,"select * from member where amount_status='paid' order by id desc");
					while($s=mysqli_fetch_array($r))
					{
                      ...
                      <tr>
                        ...
                        <td><a href="print_member.php?email=<?php echo $s['email']; ?>" target="_blank"><font color=ORANGE>Print</font></a>&nbsp;<a href="edit_member.php?member_id=<?php echo $s['id'];?>"><font color=blue>View/Renew</font></a></td>
                      </tr>
